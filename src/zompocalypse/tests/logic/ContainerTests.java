...
public class ContainerTests {
	...
	private static final String[] chest = { "chest_2_closed.png" };
	private static final String key = "gold_key_inv.png";

	@Test public void containerValidAddTest1() {
		Container c = new Container(chest, 1, null, null, false, false, false, 0);
		c.add(new Key(key,0));
	...
	@Test public void containerValidAddTest2() {
		Container c = new Container(chest, 3, null, null, false, false, false, 0);
		c.add(new Key(key,0));
	...
	@Test public void containerInavlidAddTest1() {
		Container c = new Container(chest, 0, null, null, false, false, false, 0);

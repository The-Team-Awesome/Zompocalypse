...
public class ZombieTests {
	...
	private String[] filenames = { "npc_zombie_n.png", "npc_zombie_e.png",
	...
	/**
	 * A zombie in the middle of the map should be able to move around and get
	 * to other nearby squares successfully.
	 */

	@Test
	public void zombieValidMove1() {
	...
	@Test
	public void zombieInvalidMove1() {
	...
	@Test
	public void zombieInvalidMove2() {
		StrategyZombie z = new StrategyZombie(game, 0, 0, new HomerStrategy(),
				0, filenames);
		// This sequence of movements should still leave the Zombie at the
		// position 0,0
		z.moveWest();
		z.tick(game);

...
public class ZombieTests {
	...
	@Test public void zombieValidMove1() {
		StrategyZombie z = new StrategyZombie(game, 3, 3, new HomerStrategy(), 0);
		z.moveNorth();
	...
	@Test public void zombieValidMove2() {
		StrategyZombie z = new StrategyZombie(game, 4, 4, new HomerStrategy(), 0);
	...
	@Test public void zombieInvalidMove1() {
		StrategyZombie z = new StrategyZombie(game, 0, 0, new HomerStrategy(), 0);
		z.moveNorth();

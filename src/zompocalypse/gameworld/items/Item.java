...
/**
 * Item is an interface representing any "usable" item in the game. It
 * represents the component interface class from the composite pattern.
 *
...
public interface Item extends GameObject {
	...
	/**
	 * Calling use on this item allows it to perform the appropriate behaviour
	 * of its class
	 *
	 * @param player
	 *            - the player who is using this item
	 */

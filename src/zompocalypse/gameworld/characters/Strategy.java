...
public interface Strategy extends Serializable {
	...
	/**
	 * Perform an update based on the world update tick for this specific
	 * strategy pattern.
	 */
	public void tick(World game, StrategyZombie Zombie);

	/**
	 * Points awarded to players for killing the StrategyZombie using this
	 * Strategy
	 *
	 * @return int representing the amount of points this StrategyZombie is
	 *         worth
	 */
	 ...
	 *
	 * @return int representing the amount of damage this StrategyZombie can
	 *         inflict
	 */

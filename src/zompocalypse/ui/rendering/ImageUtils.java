...
/**
 * Uses the Singleton design pattern. Provides a number of image utilities to
 * assist in the rendering of the World.
 *
...
public class ImageUtils {
	...
	} // Nothing else can instantiate a new imageutils object

	/**
	 * A public method that can return an ImageUtils object to be used. This is
	...
	/**
	 * Sets up the selection of images that this floor tile can be. There are 3
	 * possible ways to draw an item:
	 *
	 * [N] [NS,EW] [N,E,S,W]
	 *
	 * @param filenames
	...
	public ImageIcon[] setupImages(String[] filenames) {
		...
		ImageIcon[] images = new ImageIcon[filenames.length]; // image is same
																// length as
																// array
	 ...
	 * @param images
	 *            The set of images to select from
	 * @return The imageicon for the correct orientation
	 */
	public ImageIcon getImageForOrientation(Orientation orientation,
			ImageIcon[] images) {
		switch (orientation) {
		case NORTH:
			return images[0];
		...
		default:
			throw new IllegalStateException("Orientation was abnormal: "
					+ orientation);
		}
	}
